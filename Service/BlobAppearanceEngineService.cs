...
namespace Core.Services
{
    ...
    public class BlobAppearanceEngineService : IBlobId2ColorConverterService
    {
        ...
        public BlobAppearanceEngineService()
        {
    ...
    /// </summary>
    public class SingleBlobAppearanceEngineService : IBlobId2ColorConverterService
    {
        private readonly Vec4b noBlobColor = new Vec4b(0, 0, 0, 0);
        ...
        public static Vec4b GetNextRandomColor()
        {
            ...
            var color = BlobAppearanceEngineService.GetBGRAVec4bFromColor(ColorFromHSV(hue, saturation, 1));
            currentRandomIndex++;
            return color;
        }
    ...
    public class HeatMapColorForTag : IColorProviderForTag
    {
        ...
        public Vec4b GetColor(ITag<int> tag)
        {
            ...
            if (!valueExistsInDictionary)
            {
                color = BlobAppearanceEngineService.GetBGRAVec4bFromColor(HeatMap(tag.Value, 0, 1000));
